...
#define _64_TAU0_CHANNEL0_DIVISOR            (64U)
...
#define _3E7F_TAU_TDR20_VALUE               (0x3E7FU)
/* 16-bit timer data register 27 (TDR27) */
#define _1F40_TAU_TDR27_VALUE               (0x1F40U)
/* 16-bit timer data register 27 (TDR27) */
#define _0FA0_TAU_TDR27_VALUE               (0x0FA0U)
/* Clock divisor for TAU2 channel0 */
#define _1_TAU2_CHANNEL0_DIVISOR            (1U)
/* Clock divisor for TAU2 channel0 */
#define _1_TAU2_CHANNEL7_DIVISOR            (1U)
/* Clock divisor for noise filter */
